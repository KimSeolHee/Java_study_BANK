	...
	<button class="btn btn-dark mb-3 text-white"><a href="../bankAccount/add.do?bookNum=${detail.bookNum}" style="text-decoration:none; color: white;">가입하기</a></button>
		...
		<div class="row">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" readonly id="writer" placeholder="Enter your ID" value="${member.id}">
			</div>
			<div class="mb-3">
			...
			<div>
				<button type="button" id="replyButton" class="btn btn-secondary" data-booknum-num="${detail.bookNum}">댓글작성</button>
			</div>
			<div>
				<table id="commentList" class="table table-striped table-hover mt-4"></table>
				<div class="d-grid gap-2 mb-3">
					<button id="more" class="btn btn-secondary btn-lg" type="button">더보기</button>
				</div>
			</div>
					  ...
					  <div class="modal-body">
						<form>
						  <div class="mb-3">
							...
							<input type="text" class="form-control" id="recipient-name"  value="${member.id}" readonly>
						  </div>
						  <div class="mb-3">
